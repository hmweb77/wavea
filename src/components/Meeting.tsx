...
export default function Meeting() {
  return (
      <div id='contact' className='bg-blue-400 py-10 mx-4 md:mx-8 lg:mx-16 xl:mx-32 flex items-center flex-col md:flex-row justify-around text-center rounded-lg'>
      ...
      <button className='bg-yellow-200 flex items-center px-4 md:px-12 mx-0 md:mx-16 md:mt-4 rounded-lg'>
        <a href='https://calendly.com/wavea2024/15min'>
